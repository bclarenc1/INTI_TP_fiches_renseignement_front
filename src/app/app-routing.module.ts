...
import { ModifierAttributionEnfComponent } from './modifier-attribution-enf/modifier-attribution-enf.component';
...
const routes: Routes = [
	...
	{path: 'ModifierAttributionEnf', component: ModifierAttributionEnfComponent},
